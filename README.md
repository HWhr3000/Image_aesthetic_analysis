...
.├── Aesthetics-Toolbox/│   └── QIP_machine_script.py├── aesthetics_eval_pkg/│   └── aesthetics_eval/│       ├── __init__.py│       ├── postprocess.py│       └── thresholds.yml├── floward_eval.py├── out/├── run_all.py├── select_model.py└── similarity_eval.py
